      ...
      <div className="w-full max-w-sm mb-6">
        ...
        <div data-testid="player-role-card"
          ...
          <img
            ...
            alt="Rodion the Registrar"
            className="w-16 h-16 rounded-full border-2 border-amber-600 object-cover mx-auto mb-3"
          />
          <div className="text-amber-300 text-xl font-serif mb-1">{player?.name || 'Rodion the Registrar'}</div>
          <div className="text-amber-500 uppercase tracking-widest text-xs mb-2">Registrar</div>
